 ...
 * 原则：1、所有页面都依赖react、react-dom，将他们提取到一个单独的文件base.JS中

 *  2、在提出个页面被base包含的代码后，再找出所有页面都依赖的公共部分的代码，将他们提取出来放到common.JS中

 * 3、在为每个网页生成一个单独的文件，在这个文件中不在包含base.js common.JS部分的代码
